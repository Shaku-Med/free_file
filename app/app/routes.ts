...
export default [
    ...
    route(`brozystudio`, 'routes/studio/layout.tsx', [
        ...
        route(`series`, 'routes/studio/series/index.tsx'),
        route(`customization`, 'routes/studio/customization/index.tsx'),
    ...
    route(`api`, 'routes/Api/layout.tsx', [
        ...
        route(`load/auth`, 'routes/Api/load/auth/index.tsx'),
        route(`load/image/*`, 'routes/Api/load/image/index.tsx'),
        route(`load/preview/*`, 'routes/Api/load/preview/index.tsx'),
