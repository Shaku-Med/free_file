-- ============================================================
-- FEED v7.0  Instagram-Grade Personalization Engine
-- ============================================================
-- Upgrades over v6:
--   0. Playback-depth weighting  an action taken late in a video counts for
--      more than one taken at the thumbnail (file_engagement_stats_v2.sql)
--
...
BEGIN
  ...
  base AS (
    SELECT
      ...
      -- v7: playback depth of the actions this file earned. Normalised at
      -- read time so the pools can weight it like any other 0..1 term.
